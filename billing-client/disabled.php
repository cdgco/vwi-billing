...
if($configstyle != '2') {
    ...
    while ($burow = mysqli_fetch_assoc($billingresult3)) { $billingcustomers[$burow["username"]] = $bcrow["ID"]; }
    mysqli_free_result($billingresult3);mysqli_close($con);
}
else {
    
    if (!$con) { $billingcustomers = json_decode(file_get_contents( $co1 . 'billingcustomers.json'), true);}
    else { 
        $con=mysqli_connect($mysql_server,$mysql_uname,$mysql_pw,$mysql_db);
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                <h3 class="box-title m-b-0"><?php echo __("Billing Disabled For Current Account"); ?></h3><br>
                                <p>If you belive this is an error, please contact support.</p>
                            </div>
                        </div>
                    </div>
                </div>
